...
- [ ] AUTO / System theme mode (decided 2026-07-14, NOT built): a 3-way theme control — Light / Dark / **System** — cycled from the sidebar; System follows the OS `prefers-color-scheme` live; default = System; the toggle shows the current choice (e.g. "System theme"). Today the toggle is only light↔dark.
